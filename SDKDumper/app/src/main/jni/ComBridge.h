...
#ifndef SDKGENERATOR_COMBRIDGE_H
#define SDKGENERATOR_COMBRIDGE_H

#include <sstream>
#include <sys/cdefs.h>

/******* Get Android Current API Function *******/
__BEGIN_DECLS
...
void startService(JNIEnv *env, jobject ctx) {
    ...
    jclass actionString = env->FindClass("ashope/tech/generator/Floater");
...
#endif //SDKGENERATOR_COMBRIDGE_H
